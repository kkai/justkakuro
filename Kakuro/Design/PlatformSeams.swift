...
///
/// The board is tap-only, so unlike Hashi there is no drag to collide with the
/// system's interactive pop — but the leftmost column of cells sits close
/// enough to the screen edge that a slightly-missed tap-and-slide pops the
/// puzzle anyway. Losing your place mid-puzzle to that reads as the app
